...
/**
 * Comando para deshabilitar el sistema de bonificaciones por permisos
 */
public class DisableBonus implements SubcommandExecutor {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (!bonusManager.isEnabled()) {
            sender.sendMessage(MM.toComponent("<red>El sistema de bonificaciones ya está deshabilitado."));
            return;
        }
        
        // Deshabilitar el sistema
        bonusManager.setEnabled(false);
        
        // Notificar al remitente
        sender.sendMessage(MM.toComponent("<green>Has deshabilitado el sistema de bonificaciones por permisos."));
    }
}