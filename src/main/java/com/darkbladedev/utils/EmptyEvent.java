...
public class EmptyEvent extends WeeklyEvent {
    ...
    public EmptyEvent(HeartlessMain plugin, long duration) {
        ...
        this.prefix = MM.toComponent("<b><gradient:#808080:#a0a0a0:#c0c0c0:#e0e0e0:#ffffff:#ffffff:#ffffff:#ffffff:#ffffff:#e0e0e0:#c0c0c0:#a0a0a0:#808080>Evento Vacío</gradient></b>");
    }
